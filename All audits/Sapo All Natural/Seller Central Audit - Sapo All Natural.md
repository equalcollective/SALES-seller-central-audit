...
| Tier 2 | 0.06% (of ~16-18% max) | Insufficient data | Insufficient data | Impression Share | PPC testing: launch campaigns on natural/gentle/vegan cleanser queries. $72K/mo market. |
...
- The entire funnel is above industry at every stage. The only problem is visibility. This is the ideal PPC scaling scenario.
...
- Tier 2 represents a $72K/mo market where Sapo is essentially invisible. Even capturing 1% purchase share would roughly double P0's revenue.
...
The primary blocker is **impression share**: the product converts excellently when visible (1.8x industry CVR), but barely shows up on search. The first actions focus on fixing visibility through PPC, while addressing the budget misallocation between Cucumber and Calendula.
...
- **Launch Tier 2 keyword test campaigns.** Create phrase match campaigns for "natural face cleanser," "gentle face wash," "vegan face wash," "aloe face wash." Start at $3-5/day each to validate CTR and CVR on these broader terms. The SQP data shows a $72K/mo market where Sapo has 0.06% impression share.
...
- **Begin listing content preparation.** Rewrite Cucumber cleanser bullets (currently ingredient-label format, should be benefit-led). Draft A+ content expansion: cross-sell module, Cucumber vs Calendula comparison chart, trust/certification module.
...
- **Scale Tier 2 campaigns** that validated in Weeks 2-4. If "natural face cleanser" and "gentle face wash" show positive CVR, increase budgets to $10-15/day.
...
- **Scale PPC on Cucumber** based on Weeks 1-6 data. With Top of Search optimization and dedicated keyword campaigns, Cucumber should be approaching the 8-9% impression share cap on Tier 1.
- **Evaluate Tier 2 ROI.** If Tier 2 campaigns have proven CVR close to industry (14-18% for natural cleanser queries), begin scaling. This is where the real growth lives.
...
- **Tier 2 (natural/gentle/vegan cleanser) is a $72K/mo market** where the brand is invisible (0.06% impression share). This represents the biggest growth opportunity beyond the immediate PPC fixes. The product's strong Tier 1 conversion suggests it can compete on Tier 2 queries, but this needs to be validated with test campaigns.
