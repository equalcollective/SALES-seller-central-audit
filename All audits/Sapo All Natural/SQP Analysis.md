...
**Blocker detection (volume-weighted averages, Jan-Feb 2026):**
...
**Tier 2:**
- Brand clicks: 28 over 2 months (too few for reliable rate calculations)
- Impression share: 0.06% of ~16-18% adjusted cap
...
| Tier 2 | 0.06% (of ~16-18% max) | Insufficient data (28 clicks) | Insufficient data | Impression Share | PPC testing: launch campaigns on natural/gentle/vegan face cleanser queries. Start small to validate CTR and CVR before scaling. Market is 37x larger than Tier 1. |
...
**The story is clear:** P0 has a healthy product that the market wants. When shoppers see it, they click it more than average. When they click it, they add it to cart more than average. When they add it to cart, they buy it more than average. The entire funnel is above industry at every stage. The only problem is that it barely shows up (3.55% impression share on Tier 1, 0.06% on Tier 2).

This is the ideal PPC scaling scenario: the product has already proven it converts. More impressions = more sales, at a predictable rate.

## Insights

- **P0 (Face Cleansers) is under-visible, not under-performing.** The 55% revenue decline from Apr 2025 to Mar 2026 is an impression share / visibility problem, not a product or conversion problem. The product converts at 1.8x industry when it appears.
- **Tier 2 is the primary growth opportunity.** The natural/gentle/vegan face cleanser market is $72K/mo. Sapo has 0.06% impression share. Even modest PPC investment on these queries could meaningfully move revenue, assuming CTR and CVR hold at levels similar to Tier 1 (which needs to be validated first).
