...
| Tier 2 | ~276,000 | ~29,000 | ~7,300 | ~$725,000 |
...
| Tier 2 | 0.028% (cap ~24-27%) | 1.01% vs 1.36% | n/a (sample too thin) | **Impression Share** | Defer until Tier 1 is healthy, then expand into Tier 2 |
...
- Tier 2 is a $725k/mo market and the brand has 0.028% impression share. This is the biggest visible ceiling in the audit, destination for later, not the first move.
...
These actions address the CVR blocker. Listing changes take weeks to publish and stabilize, so we start them now while the PPC reclaim from Weeks 1-2 plays out.
...
- Launch "P0 | Tier 2 | Exact" manual campaign on "piggy bank," "piggy bank for adults," "piggy bank for kids", but only if Tier 1 cart-to-purchase has improved meaningfully. Tier 2 is a $725k/mo market but the brand can't compete there until conversion is healthy.
